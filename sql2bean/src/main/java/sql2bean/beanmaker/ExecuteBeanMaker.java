...
public class ExecuteBeanMaker {
	 ...
	 * @return ファイルに出力する内容
	 */
	public String write(String originalSql, String preparedSql, List<ColumnInfo> dataType, String packageName, String className, ISQLType type){

		VelocityContext context = new VelocityContext();
		context.put("list", dataType.iterator());
		context.put("package_name", packageName);
		context.put("bean_name", className);
		context.put("originalSql", originalSql);
		context.put("preparedSql", preparedSql);
