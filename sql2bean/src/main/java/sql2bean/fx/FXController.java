...
import sql2bean.fx.packagemaker.PackageMakerController;
...
public class FXController implements Initializable{
    ...
    public void btnAddPackagePressed(ActionEvent e){
    	...
    	PackageBean bean =
    			FXMain.getInstance().openPanel(PackageMakerController.class.getResourceAsStream("PackageMaker.fxml"), selected);
